...
val AppIcons.CrossSync: ImageVector
    get() {
        if (_CrossSync != null) {
            return _CrossSync!!
        }
        _CrossSync = ImageVector.Builder(
            name = "CrossSync",
            defaultWidth = 500.dp,
            ...
            path(fill = SolidColor(Color(0xFF00253C))) {
                moveTo(290.89f, 250.05f)
                curveTo(290.89f, 272.18f, 272.94f, 290.11f, 250.8f, 290.11f)
                curveTo(228.66f, 290.11f, 210.71f, 272.18f, 210.71f, 250.05f)
                curveTo(210.71f, 227.92f, 228.66f, 209.99f, 250.8f, 209.99f)
                curveTo(272.94f, 209.99f, 290.89f, 227.92f, 290.89f, 250.05f)
                close()
            }
        }.build()
...
private var _CrossSync: ImageVector? = null
